...
export const HIVE_TREASURY = "0x15184bf50b3d3f52b60434f8942b7d52f2eb436e";
/** Base mainnet chain ID */
export const HIVE_CHAIN_ID = 8453;
/** USDC contract on Base mainnet */
export const HIVE_USDC = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
// ─── Service Catalog ────────────────────────────────────────────────────────
/**
 ...
 * ```
 */
export function createHivePayer(privateKey) {
 ...
 */
export async function discoverHiveServices() {
 ...
 * ```
 */
export async function callHiveService(name, tool, args, payer) {
